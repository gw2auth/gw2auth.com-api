...
require (
	...
	github.com/its-felix/aws-lambda-go-http-adapter v0.4.2
...
require (
	...
	go.opentelemetry.io/contrib/instrumentation/github.com/aws/aws-lambda-go/otellambda v0.42.0 // indirect
